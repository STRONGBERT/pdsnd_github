...
def get_filters():
    """
    Asks user to specify a city, month, and day within the valid dates to analyze.
    ...
    """
    section()
    print('Hello! Let\'s explore some US bikeshare files!'.center(80))
    section()
    print("\n\tYou will have to choose a dataset by entering the name of the city.".center(80))
    print("\tYou will have to choose the month(s) and day(s) for which the data will be filtered.".center(80))
    print("\tSee the table below".center(80))
    section()
...
def get_city(city_data):
    ...
    while True:
        ...
        if num in range(1, len(list_of_cities) + 1):
            break

    chosen_city = list_of_cities[num - 1]
    return chosen_city
...
def get_month(mon):
    ...
    while True:
        try:
            month = input(" Enter the number corresponding to the month or 'a' for all:  ")
        except ValueError:
            continue
...
def get_day(days_of_week):
    ...
    while True:
        try:
            day = input(" Enter the number corresponding to the day or 'a' for all:  ")
        except ValueError:
            continue
